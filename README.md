...
I'm a **Final Year B.Tech (Data Science)** student passionate about building **production-ready AI applications** powered by **LLMs, RAG, AI Agents, and scalable backend systems**.

- 🤖 Building intelligent applications with **LangChain**, **LangGraph**, **OpenAI**, and **FastAPI**
- ⚡ Designing scalable backend systems using **Go**, **Node.js**, **Spring Boot**, and **MongoDB**
- ☁️ Exploring **MLOps**, **AI Infrastructure**, and **Cloud Deployment**
